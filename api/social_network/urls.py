...
api_v1_urlpatterns = [
    path(
        ...
        include(("social_network.apps.accounts.api.urls", "accounts"), namespace="api-v1-accounts"),
    ),
    path(
        f"{API_PREFIX}/v1/posts/",
        include(("social_network.apps.posts.api.urls", "posts"), namespace="api-v1-posts"),
    ),
]
...
# enable Swagger
if "SWAGGER" in settings.SOCIAL_NETWORK_FEATURES:
