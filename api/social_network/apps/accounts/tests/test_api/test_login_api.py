...
LOGIN_SERIALIZER_PATH = "social_network.apps.accounts.api.serializers.login.LoginSerializer"
...
def test_login_api_success(user_account, unauthorized_api_client, mocker):
    ...
    mocked_login = mocker.patch(
        "social_network.apps.accounts.services.login.LoginService.login", return_value=mocked_response
    )
