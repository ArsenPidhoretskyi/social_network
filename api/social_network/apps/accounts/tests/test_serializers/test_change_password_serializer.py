...
from social_network.apps.accounts.api.serializers.password import ChangePasswordSerializer
from social_network.apps.accounts.exceptions import InvalidPasswordError, WrongPasswordError
...
def test_validate_old_password_failure(change_password_serializer_request, mocker):
    ...
    assert "test_validate_old_password_failure" in str(error.value)
    mocked_check_password.assert_called_once_with(change_password_serializer_request.user, OLD_PASSWORD)
...
def test_validate_new_password_failure(change_password_serializer_request, mocker):
    ...
    assert "test_validate_new_password_failure" in str(error.value)
